...
class JdbcUpstreamModelRepositoryTest {
    ...
    void roundTripsNullableCapabilitiesOnStandaloneH2Schema() throws Exception {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            repository.insert(connection, new UpstreamModelRecord(modelId, channelId,
            ...
            UpstreamModelRecord loaded = repository.findLiveById(connection, modelId).orElseThrow();
