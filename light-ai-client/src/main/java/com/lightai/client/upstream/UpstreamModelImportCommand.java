...
/**
 * 模型导入命令（BACKEND_PLAN 2 协议字典 UpstreamModelImportCommand）。
 * source=PROVIDER_API 时 channel_credential_id 必填；逐对象事务提交（C-005）。
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record UpstreamModelImportCommand(
        String channelId,
        String source,
    ...
    public UpstreamModelImportCommand {
