...
public enum ErrorCode {
    ...
    IDEMPOTENCY_KEY_CONFLICT(409, false, ErrorType.CONFLICT),
    ...
    APPLICATION_TOKEN_QUOTA_EXHAUSTED(429, false, ErrorType.RATE_LIMIT),
    APPLICATION_AMOUNT_BUDGET_EXHAUSTED(429, false, ErrorType.RATE_LIMIT),
    APPLICATION_QUOTA_INACTIVE(403, false, ErrorType.PERMISSION),
    APPLICATION_MODEL_CONSTRAINT_VIOLATED(403, false, ErrorType.PERMISSION),
    RISK_POLICY_BLOCKED(403, false, ErrorType.PERMISSION),
