 ...
 * channel_credential_id/credential_name/credential_masked_value 与 channel_request_id
...
public record TraceAttemptItem(
        ...
        String upstreamModelNameSnapshot,
        String modelIdSnapshot,
        String channelCredentialNameSnapshot,
        String credentialMaskedValue,
        OffsetDateTime startedAt,
        OffsetDateTime channelStartedAt,
