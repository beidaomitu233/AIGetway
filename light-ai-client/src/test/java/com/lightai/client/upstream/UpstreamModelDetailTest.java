 ...
 */
class UpstreamModelDetailTest {

    private static UpstreamModelDetail detail(String tokenizer, Long context, Long output,
                                              Boolean stream) {
        return new UpstreamModelDetail("id", "p1", "OpenAI", "gpt-4o", "GPT-4o", "CHAT_TEXT",
    ...
    void importedDisabledModelMayLackCapabilities() {
        UpstreamModelDetail imported = detail(null, null, null, null);
    ...
    void enabledModelRequiresFullCapabilities() {
        UpstreamModelDetail complete = detail("o200k", 128000L, 16384L, true);
    ...
    void contextMustStrictlyExceedMaxOutput() {
        UpstreamModelDetail equal = detail("o200k", 16384L, 16384L, true);
