...
| 状态 | 数量 | 关键编号 |
| --- | ---: | --- |
| 初次发现并已修复 | 5 组 | UI-ANT-342-001～005 |
| 当前已验证 | 6 组 | UI-ANT-342-001～005、UI-ANT-343-001 |
| P0/P1 剩余代码问题 | 0 | — |
...
- 代码按任务包拆分提交，最近提交为 `fd4a500 refactor(frontend): UI-R342 清理用量与总览旧卡片容器`；完整提交历史保留在当前分支。
