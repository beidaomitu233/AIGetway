...
任务领取与文件占用见 [TASK_STATUS.md](TASK_STATUS.md)，契约差异、开发假设和环境绕行方法见 [COMMUNICATION.md](COMMUNICATION.md) 第 6 节。允许按 P20～P23 开发与验证；未确认的业务选项只约束对应任务，不能再次以“V2 尚未合入”阻塞全部开发。代码资产仍须逐包验收。
