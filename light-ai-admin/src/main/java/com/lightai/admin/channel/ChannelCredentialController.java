...
public class ChannelCredentialController {
    ...
    @GetMapping("/admin/credential-pools/{channelId}/credentials")
    ...
    @PostMapping("/admin/credential-pools/{channelId}/credentials")
    ...
    public ResponseEntity<String> check(@PathVariable String id, @RequestBody String body,
        ...
        ChannelCheckRecord record = credentialService.check(context(request), id, command);
